...
if __name__=='__main__':
    ...
    print("1")
    GraspPointDetector.set_workspace(np.array([[881, 28], [499, 34], [505, 681], [890, 666]]).flatten())
    print("2")
    GraspPointDetector.set_threshold(0.8)
    GraspPointDetector.set_width_range(np.array([[50, 60], [10, 15], [80,90]]).flatten())
    GraspPointDetector.set_npose(300)
    GraspPointDetector.set_top_n(10)
