...
def parse_args():
    ...
    parser.add_argument(
        "--img_path", type=str, default="./images/0_img.png", help="path to image file"
...
def main(args):
    ...
    # plt.imshow(everything_results[0].orig_img)
    # plt.show()
    # print(len(everything_results[0].orig_img))
    # print(len(everything_results[0].orig_img[0]))
    # print(len(everything_results[0].orig_img[0][0]))
    # print(len(everything_results[0].orig_img[0][0][0]))
    
    # color_list = []
    # for i in everything_results[0].orig_img:
    #     for j in i:
    #         if j[2] in color_list:
    #             pass
    #         else:
    ...
    # file_path = "/home/lee/fastsam/FastSAM/output/output.txt"

    # # 파일 열고 내용 저장
    # with open(file_path, "w") as f:
    #     f.write(str(everything_results[0].orig_img[0]))
    ...
    print(prompt_process.results[0].masks.data)
